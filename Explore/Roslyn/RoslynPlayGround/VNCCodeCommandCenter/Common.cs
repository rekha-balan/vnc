...
namespace VNCCodeCommandCenter
{
    public class Common
    {
        ...
        // TODO(crhodes): Get rid of this (I think) and use the one from VNCCodeCommandCenter.  See if need anything else
        ...
        public static Data.ApplicationDataSet ApplicationDataSet
        {
            get
            {
                ...
                {
                    //_ApplicationDataSet = new VNCCodeCommandCenter.Data.ApplicationDataSet();
