...
public class NotificationHub : Hub
{
    ...
    public string SendNotifications()
    {
        ...
        {
            string query = "SELECT  NewMessageCount, NewCircleRequestCount, NewNotificationsCount, NewJobNotificationsCount FROM [dbo].[NewMessages] WHERE UserProfileId=" + "61958";
            connection.Open();
