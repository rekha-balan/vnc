...
namespace VNCDxWPFWindowAppBase1
{
    public class Common
    {
        public const string PROJECT_NAME = "APPNAME";
        public const string LOG_APPNAME = "APPNAME";

        public const string cCONFIG_FILE = @"C:\temp\APPNAME.xml";
        ...
        // TODO(crhodes): Get rid of this (I think) and use the one from VNCDxWPFWindowAppBase1.  See if need anything else
        ...
        public static Data.ApplicationDataSet ApplicationDataSet
        {
            get
            {
                ...
                {
                    //_ApplicationDataSet = new VNCDxWPFWindowAppBase1.Data.ApplicationDataSet();
