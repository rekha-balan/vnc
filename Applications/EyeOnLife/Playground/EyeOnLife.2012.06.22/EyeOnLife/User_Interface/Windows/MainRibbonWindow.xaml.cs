...
namespace SQLInformation.User_Interface.Windows
{
    ...
    public partial class MainRibbonWindow
    {
        ...
        private void OnDisplayRoot3_Click(object sender, RoutedEventArgs e)
        {
            wucServers.Visibility = System.Windows.Visibility.Collapsed;
            wucInstances.Visibility = System.Windows.Visibility.Collapsed;
            //Root3.Visibility = System.Windows.Visibility.Visible;
        }

        private void OnAdministration_Click(object sender, RoutedEventArgs e)
        {
            SQLInformation.User_Interface.Windows.SQLMonitorDBAdminMain win1 = new SQLMonitorDBAdminMain();
            win1.Show();
        }
        ...
        {
            //Root3.Visibility = System.Windows.Visibility.Collapsed;
            wucServers.Visibility = System.Windows.Visibility.Visible;
            wucInstances.Visibility = System.Windows.Visibility.Collapsed;
        }
        ...
        private void OnDisplayInstances_Click(object sender, RoutedEventArgs e)
        {
            //Root3.Visibility = System.Windows.Visibility.Collapsed;
            wucServers.Visibility = System.Windows.Visibility.Collapsed;
            wucInstances.Visibility = System.Windows.Visibility.Visible;
        }
    }
}
