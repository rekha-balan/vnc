...
namespace EyeOnLife
{
    public class Detail3DManager
    {
      ...
      #region Globals
        ...
        //FrameworkElement detailBackGrid;
        TranslateTransform detailBackGridTranslate;
        TranslateTransform detailFrontGridTranslate;
        ...
        public Detail3DManager(object fe)
        {
            ...
            detailFront2D = (FrameworkElement)baseFrameworkElement.FindName("DetailFrontGrid");
            detailBack2D = (FrameworkElement)baseFrameworkElement.FindName("DetailBackGrid");
            detailBackGridTranslate = (TranslateTransform)baseFrameworkElement.FindName("DetailBackGridTranslate");
            detailFrontGridTranslate = (TranslateTransform)baseFrameworkElement.FindName("DetailFrontGridTranslate");
            masterView2DWrapperTranslate = (TranslateTransform)baseFrameworkElement.FindName("MasterView2DWrapperTranslate");
            //detailBackGrid = (FrameworkElement)baseFrameworkElement.FindName("DetailBackGrid");
            detailMain = (FrameworkElement)baseFrameworkElement.FindName("DetailGrid");
            ...
            detailBackGridTranslate.X = 10000; // move back offscreen
        ...
        public void ShowDetailBack()
        {
            ...
            detailFrontGridTranslate.X = 10000;
            detailBackGridTranslate.X = 10000;
