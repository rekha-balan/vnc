...
GO
PRINT N'Dropping DF__tmp_ms_xx_In__ID__5F492382...';


GO
ALTER TABLE [dbo].[Instances] DROP CONSTRAINT [DF__tmp_ms_xx_In__ID__5F492382];


GO
PRINT N'Dropping DF__tmp_ms_xx__Expan__6319B466...';


GO
ALTER TABLE [dbo].[Instances] DROP CONSTRAINT [DF__tmp_ms_xx__Expan__6319B466];


GO
PRINT N'Dropping DF__tmp_ms_xx__IsMon__603D47BB...';


GO
ALTER TABLE [dbo].[Instances] DROP CONSTRAINT [DF__tmp_ms_xx__IsMon__603D47BB];


GO
PRINT N'Dropping DF__tmp_ms_xx__Expan__61316BF4...';


GO
ALTER TABLE [dbo].[Instances] DROP CONSTRAINT [DF__tmp_ms_xx__Expan__61316BF4];


GO
PRINT N'Dropping DF__tmp_ms_xx__Expan__6225902D...';


GO
ALTER TABLE [dbo].[Instances] DROP CONSTRAINT [DF__tmp_ms_xx__Expan__6225902D];


GO
PRINT N'Dropping DF__tmp_ms_xx__Expan__65F62111...';


GO
ALTER TABLE [dbo].[Instances] DROP CONSTRAINT [DF__tmp_ms_xx__Expan__65F62111];


GO
PRINT N'Dropping DF__tmp_ms_xx__Expan__640DD89F...';


GO
ALTER TABLE [dbo].[Instances] DROP CONSTRAINT [DF__tmp_ms_xx__Expan__640DD89F];


GO
PRINT N'Dropping DF__tmp_ms_xx__Expan__6501FCD8...';


GO
ALTER TABLE [dbo].[Instances] DROP CONSTRAINT [DF__tmp_ms_xx__Expan__6501FCD8];


GO
PRINT N'Dropping DF__Instances__Defau__5A4F643B...';


GO
ALTER TABLE [dbo].[Instances] DROP CONSTRAINT [DF__Instances__Defau__5A4F643B];


GO
PRINT N'Dropping DF__Instances__Defau__5B438874...';


GO
ALTER TABLE [dbo].[Instances] DROP CONSTRAINT [DF__Instances__Defau__5B438874];
...
GO
PRINT N'Dropping FK_LinkedServers_Instances...';


GO
ALTER TABLE [dbo].[LinkedServers] DROP CONSTRAINT [FK_LinkedServers_Instances];
...
GO
PRINT N'Dropping FK_JobServers_Instances...';


GO
ALTER TABLE [dbo].[JobServers] DROP CONSTRAINT [FK_JobServers_Instances];
...
CREATE TABLE [dbo].[tmp_ms_xx_Instances] (
    ...
    [ExpandJobServer]            BIT              DEFAULT 0 NULL,
    [ExpandLogins]               BIT              DEFAULT 0 NULL,
    [ExpandServerRoles]          BIT              DEFAULT 0 NULL,
    [ExpandTriggers]             BIT              DEFAULT 0 NULL,
    [DefaultDatabaseExpandMask]  INT              DEFAULT 0 NULL,
    [DefaultJobServerExpandMask] INT              DEFAULT 0 NULL,
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Instances] ([ID], [Server_ID], [Name_Instance], [BrowserStartMode], [Collation], [Edition], [EngineEdition], [IsClustered], [NetName], [OSVersion], [PerfMonMode], [PhysicalMemory], [Platform], [Processors], [Product], [ProductLevel], [ServiceInstanceId], [ServiceName], [ServiceAccount], [Status], [Version], [IsMonitored], [ExpandContent], [ExpandStorage], [ExpandJobServer], [ExpandLogins], [ExpandServerRoles], [ExpandTriggers], [DefaultDatabaseExpandMask], [DefaultJobServerExpandMask], [SnapShotDate], [SnapShotError])
        SELECT   [ID],
                 [Server_ID],
                 [Name_Instance],
                 [BrowserStartMode],
...
GO
ALTER TABLE [dbo].[LinkedServers] WITH NOCHECK
...
GO
ALTER TABLE [dbo].[JobServers] WITH NOCHECK
...
ALTER TABLE [dbo].[LinkedServers] WITH CHECK CHECK CONSTRAINT [FK_LinkedServers_Instances];
...
ALTER TABLE [dbo].[JobServers] WITH CHECK CHECK CONSTRAINT [FK_JobServers_Instances];
