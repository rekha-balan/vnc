...
GO
/*
The column [dbo].[Instances].[ExpandDatabases] is being dropped, data loss could occur.

The column [dbo].[Instances].[ExpandInstance] is being dropped, data loss could occur.
*/

IF EXISTS (select top 1 1 from [dbo].[Instances])
