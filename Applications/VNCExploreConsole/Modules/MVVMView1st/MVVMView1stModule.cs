...
namespace MVVMView1st
{
    public class MVVMView1stModule : IModule
    {
        ...
        public void Initialize()
        {
            ...
            // because ContentA_V1 implements IContentA_V1
            // Do same for IContentA_V1_ViewModel, ContentA_V1_ViewModel

            _container.RegisterType<ToolbarA>();
            //_container.RegisterType<ContentA_V1>();   // Don't have to use interface but recommended.
            _container.RegisterType<IContentA_V1, ContentA_V1>();
            _container.RegisterType<IContentA_V1_ViewModel, ContentA_V1_ViewModel>();
