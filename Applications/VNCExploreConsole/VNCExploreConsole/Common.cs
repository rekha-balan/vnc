...
namespace VNCExploreConsole
{
    public class Common
    {
        public const string PROJECT_NAME = "VNCExploreConsole";
        public const string LOG_APPNAME = "VNCExploreConsole";
        public const string APPNAME = "EASE Command Console";

        public const string cCONFIG_FILE = @"C:\temp\EASECommandConsole_Config.xml";
