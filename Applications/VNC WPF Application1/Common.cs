...
namespace VNC_WPF_Application1
{
    ...
    public static class Common
    {
        ...
        public const string LOG_APPNAME = "VNC_WPF_Application1";
        ...
        private static VNC_WPF_Application1.Data.ApplicationDS _ApplicationDS;

        public static VNC_WPF_Application1.Data.ApplicationDS ApplicationDS
        {
            get
            {
                if (_ApplicationDS == null)
                {
                    _ApplicationDS = new VNC_WPF_Application1.Data.ApplicationDS();
