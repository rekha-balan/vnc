...
namespace VNC_WPF_Application1
{
    ...
    public partial class App : Application
    {
        ...
        private void Application_Startup(object sender, StartupEventArgs e)
        {
            ...
            try
            {
                if (VNC_WPF_Application1.Data.Config.ADBypass)
                {
                ...
                {
                    if (!VNC_WPF_Application1.Data.Config.AD_Users_AllowAll)
                    {
                        bool isAuthorizedUser = VNCAD.Helper.CheckGroupMembership(
                            //"maward", 
                            Common.CurrentUser.Identity.Name,
                            VNC_WPF_Application1.Data.Config.ADGroup_Users,
                            VNC_WPF_Application1.Data.Config.AD_Domain);

                        if (!isAuthorizedUser)
                        {
                            MessageBox.Show(string.Format("You must be a member of {0}\\{1} to run this application.",
                                VNC_WPF_Application1.Data.Config.AD_Domain, VNC_WPF_Application1.Data.Config.ADGroup_Users));
                            return;
                        }
                    }
                    ...
                    Common.IsAdministrator = VNCAD.Helper.CheckDirectGroupMembership(
                        Common.CurrentUser.Identity.Name,
                        VNC_WPF_Application1.Data.Config.ADGroup_Administrators,
                        VNC_WPF_Application1.Data.Config.AD_Domain);


                    Common.IsBetaUser = VNCAD.Helper.CheckDirectGroupMembership(
                        Common.CurrentUser.Identity.Name,
                        VNC_WPF_Application1.Data.Config.ADGroup_BetaUsers,
                        VNC_WPF_Application1.Data.Config.AD_Domain);
