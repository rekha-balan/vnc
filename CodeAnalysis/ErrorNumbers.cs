...
namespace VNC.CodeAnalysis
{
    ...
    {
        public const string CLASSNAME = "VNCCodeAnalysis";
        // Application Base

        private const int CLASS_BASE_ERRORNUMBER = 0;
        public const int APPERROR = CLASS_BASE_ERRORNUMBER;

        // Helper

        public const int HELPER = CLASS_BASE_ERRORNUMBER + 0;

        public const int HELPERS_COMMAND = CLASS_BASE_ERRORNUMBER + 0;
        public const int HELPERS_EMAIL = CLASS_BASE_ERRORNUMBER + 0;
        public const int HELPERS_EXTERNALPROGRAM = CLASS_BASE_ERRORNUMBER + 0;


        // HIS DLL

        public const int HIS = CLASS_BASE_ERRORNUMBER + 0;

        // HIS TESTER

        public const int HIS_TESTER = CLASS_BASE_ERRORNUMBER + 500;

        // HIS ADMINISTRATION

        public const int HIS_ADMINISTRATION = CLASS_BASE_ERRORNUMBER + 600;

        // HIS DAL DLLs

        public const int HIS_DAL_MOCK = CLASS_BASE_ERRORNUMBER + 1000;

        public const int HIS_DAL_SQL_BASE = CLASS_BASE_ERRORNUMBER + 2000;
        ...
        public const int HIS_LIBRARY_BASE = CLASS_BASE_ERRORNUMBER + 3000;
