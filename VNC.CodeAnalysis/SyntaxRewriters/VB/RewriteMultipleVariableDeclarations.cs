...
{
    public class RewriteMultipleVariableDeclarations : VisualBasicSyntaxRewriter
    {
        ...
        public RewriteMultipleVariableDeclarations(string comment="Rewritten by a button")
        {
            _comment = comment;
        }
