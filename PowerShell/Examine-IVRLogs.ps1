...
param($firstNamedArgument, $secondNamedArgument = 0)
...
function GetArgumentsFunction
{
	...
	"    First glboal positional function argument is: " + $global:args[0]
	...
	# Display the arguments by name
	"    First named functionargument is: " + $argumentOne
...
function GetArgumentsFunction3
{
	...
	# or it will not work.  Uncommment the next line to see what happens.
