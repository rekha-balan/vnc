...
.DESCRIPTION
Used to call PacificLife.Life.PLLog from PowerShell scripts.
		
.EXAMPLE
Call-PLLog -Info -Message "Message to Log goes here"
.EXAMPLE
Call-PLLog -Trace -Message "Doing Step One" -class "MyClass" -method "MyMethod"
