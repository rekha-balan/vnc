...
v1.0.0 Christopher Rhodes, 2015.04.27, First American
...
# <TODO: Add code, functional calls here to do something cool>
    ...
    # CreateNavigationLinksFile
    
    # CreateCustomerKPIsFile
    
    # CreateFinancialKPIsFile
    
    # CreatePeopleKPIsFile

    # CreateProcessKPIsFile
...
function CreateNavigationLinksFile()
{
    $outputfilename = $Name + "-NavigationLinks.txt"

    $message = "Creating $OutputPath\$OutputFileName"
    LogMessage $message "CreateInputFile" "Info"
    
    $body = @"
<div class="faL0NavigationLinks">
<h1>This is content for $Name NavigationLinks</h1>
<h2>Content is coming from a .txt file in the Site Collection Content library</h2>
<h3>File Content is displayed using a Content Editor Web Part</h3>
<h3>Content can be styled if appropriate id and class markup is provided</h3>
<div>
</div>
"@
...
function CreateCustomerKPIsFile()
{
    $Outputfilename = $Name + "-CustomerKPIs.txt"

    $message = "Creating $OutputPath\$OutputFileName"
    LogMessage $message "CreateOutputFile" "Info"

    $body = @"
<h1 class="faL0CustomerKPI">This is content for $Name CustomerKPIs</h1>
<h2>Content is coming from a .txt file in the Site Collection Content library</h2>
<h3>File Content is displayed using a Content Editor Web Part</h3>
<h3>Content can be styled if appropriate id and class markup is provided</h3>
<div>
<a href="../Pages/Architecture-Team.aspx">
<img src="../SiteAssets/Page%20Types/Metric.png" alt="Metric" />
</a>
</div>
"@
...
function CreateFinancialKPIsFile()
{
    $Outputfilename = $Name + "-FinancialKPIs.txt"

    $message = "Creating $OutputPath\$OutputFileName"
    LogMessage $message "CreateOutputFile" "Info"

    $body = @"
<h1 class="faL0FinancialKPI">This is content for $Name FinancialKPIs</h1>
<h2>Content is coming from a .txt file in the Site Collection Content library</h2>
<h3>File Content is displayed using a Content Editor Web Part</h3>
<h3>Content can be styled if appropriate id and class markup is provided</h3>
<div>
...
function CreatePeopleKPIsFile()
{
    $Outputfilename = $Name + "-PeopleKPIs.txt"

    $message = "Creating $OutputPath\$OutputFileName"
    LogMessage $message "CreateOutputFile" "Info"

    $body = @"
<h1 class="faL0PeopleKPI">This is content for $Name PeopleKPIs</h1>
<h2>Content is coming from a .txt file in the Site Collection Content library</h2>
<h3>File Content is displayed using a Content Editor Web Part</h3>
<h3>Content can be styled if appropriate id and class markup is provided</h3>
<div>
...
function CreateProcessKPIsFile()
{
    $Outputfilename = $Name + "-ProcessKPIs.txt"

    $message = "Creating $OutputPath\$OutputFileName"
    LogMessage $message "CreateOutputFile" "Info"

    $body = @"
<h1 class="faL0ProcessKPI">This is content for $Name ProcessKPIs</h1>
<h2>Content is coming from a .txt file in the Site Collection Content library</h2>
<h3>File Content is displayed using a Content Editor Web Part</h3>
<h3>Content can be styled if appropriate id and class markup is provided</h3>
<div>
