...
namespace VNCWPFUserControls
{
    public class Common
    {
        ...
        // TODO(crhodes): Get rid of this (I think) and use the one from VNCWPFUserControls.  See if need anything else
        ...
        public static Data.ApplicationDataSet ApplicationDataSet
        {
            get
            {
                ...
                {
                    //_ApplicationDataSet = new VNCWPFUserControls.Data.ApplicationDataSet();
